	...
	function create_field( $field )
	{
		...
		*/
		...
		<div>
			...
			<select name="<?php echo $field['name']; ?>" class="portal-project-users <?php echo $field['class']; ?>">

				<?php if(($field['value']) && ($field['value'] != 'unassigned')): ?>
					<option value="unassigned"></option>
					<option value="<?php echo esc_attr($field['value']); ?>" selected><?php echo esc_html( portal_username_by_id($field['value']) ); ?></option>
				<?php else: ?>
					<option value="unassigned"></option>
				<?php endif; ?>
				...
				foreach( $users as $user ):
					...
					if( isset($user_obj->ID) ): ?>
						<option value="<?php echo esc_attr($user); ?>"><?php echo esc_html( portal_username_by_id($user_obj->ID) ); ?></option>
					<?php
					endif;
				endforeach; ?>
