		...
		'portal_settings_appearance'    => apply_filters( 'portal_settings_appearance',
			array(
				'main'           => array(
					...
					'portal_logo'                        => array(
						'id'        => 'portal_logo',
						'name'      => __( 'Logo for Project Pages', 'portal_projects' ),
						'type'      => 'upload',
		...
		'portal_settings_notifications' => apply_filters( 'portal_settings_notifications', array(
			'email' => array(
				...
				'portal_default_message' => array(
					...
					'name' => __( 'Message', 'portal_projects' ),
					'type' => 'textarea',
		...
		'portal_settings_advanced'      => apply_filters( 'portal_settings_advanced',
			array(
				'main' => array(
					...
					'portal_rerun_migration'    => array(
						'id'          => 'portal_rerun_migration',
						'name'        => __( 'Re-run milestone upgrade script', 'portal_projects' ),
						'type'        => 'button_link',
						'href'        => get_site_url() . '/wp-admin/index.php?portal_upgrade_db=0',
						'button_text' => __( 'Rerun Upgrade', 'portal_projects' )
					),
					'portal_old_milestones'     => array(
						'id'          => 'portal_old_milestones',
						'name'        => __( 'Revert back to old milestone system', 'portal_projects' ),
						'type'        => 'button_link',
						'href'        => get_site_url() . '/wp-admin/index.php?portal_db_rollback=3',
						'button_text' => __( 'Revert', 'portal_projects' )
					)
				)
			)
		),
